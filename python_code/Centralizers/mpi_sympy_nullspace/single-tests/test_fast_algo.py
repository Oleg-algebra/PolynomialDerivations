...
from python_code.Centralizers.mpi_sympy_nullspace.basicClasses.commutatorSearchFast import  Derivation, FastCommutatorFinder
...
finder = FastCommutatorFinder(der, max_k=10)
